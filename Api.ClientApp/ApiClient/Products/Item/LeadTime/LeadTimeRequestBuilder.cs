...
using System;
namespace ApiClient.Products.Item.LeadTime
{
    /// <summary>
    /// Builds and executes requests for operations under \products\{id}\lead-time
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class LeadTimeRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ApiClient.Products.Item.LeadTime.LeadTimeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LeadTimeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/products/{id}/lead-time", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiClient.Products.Item.LeadTime.LeadTimeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LeadTimeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/products/{id}/lead-time", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiClient.Products.Item.LeadTime.LeadTimeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ApiClient.Products.Item.LeadTime.LeadTimeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ApiClient.Products.Item.LeadTime.LeadTimeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class LeadTimeRequestBuilderPatchRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
